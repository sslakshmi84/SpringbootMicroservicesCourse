...
public class RabbitMQConfig {
    ...
    Binding newOrdersQueueBinding() {
        return BindingBuilder.bind(newOrdersQueue()) // 1️⃣ Bind this queue
                .to(exchange()) // 2️⃣ To this exchange
                .with(properties.newOrdersQueue()); // 3️⃣ Using this routing key
    }
